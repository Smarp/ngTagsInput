    ...
    return {
        ...
        controller: ["$scope", "$attrs", "$element", function($scope, $attrs, $element) {
            ...
            tagsInputConfig.load('tagsInput', $scope, $attrs, {
                ...
                enableDeleteRemove: [Boolean, true],
        ...
        link: function(scope, element, attrs, ngModelCtrl) {
            ...
            events                
                ...
                .on('input-keydown', function(event) {
                    ...
                    shouldSelect = (((key === KEYS.backspace && options.enableBackspaceRemove) || key === KEYS.left || key === KEYS.right) && scope.newTag.text().length === 0 && !options.enableEditingLastTag) && options.enableSelect;
